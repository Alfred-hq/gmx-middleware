...
feeData.traderDiscountFactor=returnValueOrZero(data.getUintItem("traderDiscountFactor")).times(collateralTokenPriceMin)
...
feeData.fundingFeeAmount=returnValueOrZero(data.getUintItem("fundingFeeAmount")).times(collateralTokenPriceMin)
...
feeData.borrowingFeeAmount=returnValueOrZero(data.getUintItem("borrowingFeeAmount")).times(collateralTokenPriceMin)
...
feeData.positionFeeAmount=returnValueOrZero(data.getUintItem("positionFeeAmount")).times(collateralTokenPriceMin)
feeData.totalCostAmount=returnValueOrZero(data.getUintItem("totalCostAmount")).times(collateralTokenPriceMin)
feeData.uiFeeReceiverFactor=returnValueOrZero(data.getUintItem("uiFeeReceiverFactor"))
feeData.uiFeeAmount=returnValueOrZero(data.getUintItem("uiFeeAmount")).times(collateralTokenPriceMin)
